...
export default function MawjLogo({ size = 48, animated = false, color = 'var(--action)' }: LogoProps) {
    ...
    >
      ...
      <g style={animated ? { animation: 'fillLogo 2s ease forwards' } : {}}>
        <path
          ...
          stroke={color} strokeWidth="9" strokeLinecap="round" fill="none" style={style}
        />
        <path
...
export function MawjLogoImg({ size = 48 }: { size?: number }) {
  return (
    <img
      src="/logo.png"
      width={size}
