...
function getMonthKeys(orders: any[], expenses: any[], remittances: any[]): string[] {
  ...
  return [...keys].filter(Boolean).sort().reverse() as string[]
}
...
function SectionRow({ label, value, sub, color, indent, bold, border }: { label?: any; value?: any; sub?: any; color?: any; indent?: any; bold?: any; border?: any }) {
  return (
    <div style={{
...
function PnLSection({ children, style }: { children?: any; style?: any }) {
  return (
    <div style={{
...
/* ─────────────────────────────────────────────────────────
   TAB 1: P&L
───────────────────────────────────────────────────────── */
function PnLTab({ orders, expenses, monthFilter, setMonthFilter }: { orders?: any; expenses?: any; monthFilter?: any; setMonthFilter?: any }) {
