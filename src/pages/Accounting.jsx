  ...
  return (
    <div>
      ...
      <div style={{
        ...
        background: netProfit >= 0 ? 'rgba(0,228,184,0.08)' : 'rgba(239,68,68,0.08)',
        border:`2px solid ${netProfit >= 0 ? 'rgba(0,228,184,0.3)' : 'rgba(239,68,68,0.3)'}`,
        display:'flex', justifyContent:'space-between', alignItems:'center',
        marginBottom:12,
      }}>
        <div>
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        background: estimatedCash >= 0 ? 'rgba(0,228,184,0.06)' : 'rgba(239,68,68,0.06)',
        border:`2px solid ${estimatedCash >= 0 ? 'rgba(0,228,184,0.25)' : 'rgba(239,68,68,0.25)'}`,
        ...
        {partners.map(partner => {
          ...
          return (
            <div key={partner.id} style={{ background:'var(--bg-surface)', borderRadius:'var(--r-md)', overflow:'hidden', boxShadow:'var(--card-shadow)' }}>
              {/* Header */}
              <div style={{ padding:'14px 16px', background: netEquity >= 0 ? 'rgba(0,228,184,0.06)' : 'rgba(239,68,68,0.06)', borderBottom:'1px solid var(--border)', display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                <div>
